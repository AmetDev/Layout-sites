export function Header() {
    return (
       <header className="mb-[314px]">
        ...
        {/* my  max-2xl:justify-between*/}
        <div className=" h-20 flex items-center justify-center">
            {/* flex items-center */}
            {/* my  */}
            <ul className="flex items-center  max-2xl:justify-between">
                <div className="mr-[203px]">
                ...
                <div className="flex text-white text-[30px] font-medium items-center max-2xl:hidden">
