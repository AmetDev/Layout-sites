export function Begin() {
    return (
        <div className="mt-[230px] bg-slate-500">
            <div className="inline-block w-[730px] ">
                <div className="">
                    <h1 className="text-white font-semibold text-4xl ml-[32px]">Lorem ipsum dolor sit amet</h1>
                    <div>
                    <p className="text-[18px] text-[#BCBCBC] font-semibold ml-[92px] max-w-screen-sm mt-[52px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
